...
const ProLevelSeoPackage = () => {
  const [count, setCount] = useState(1);

  const single = {
    name: "Pro Level Seo package",
    imgSrc: "/images/seo-concept-1024x683-1-600x400.jpg",
    price: "499.99",
    qty: count,
    id: "5",
  };
      ...
      <div className="single-product-top">
        ...
        <div className="single-product-top-right">
          ...
          <div className="single-product-short-des">
            <p>
              Rank Targeting and Tracking for 100+ Keywords <br />
              <br />
              Full Technical On-Page Optimization <br />
              <br />
              Off-Page Optimization with Linking <br />
              <br />6 Original Content/Blog Posts
            </p>
          </div>
...
export default ProLevelSeoPackage;
